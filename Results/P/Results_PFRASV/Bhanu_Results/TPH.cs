...
namespace WITP_TPH
{
    class TPH
    {
        ...
        float PickTechCost;
        float FT_PUTCOST = 320;
        float FT_PICKCOST = 320;
        float PT_PUTCOST = 240;
        float PT_PICKCOST = 240;
        float gamma = 0.5F;                     //Percentage of fulll time workers allowed to work as part time at the warehouse
        float phi = 1.0F;
        ...
        int _beginTime = 0;                    //Begin time period for fashion event in the time-horizon
        int _endTime = 3;                      //*********End time-period for fashion event in the time-horizon ...very important..check for every data set else it will throw out of memory exception
        int _dueTime = 4;                      //Due date for fashion products to reach store..in the time-horizon
        int pt = 1;                             //processing time of a product at warehouse 
